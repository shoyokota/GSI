...
!from mg_filtering.f90
  ...
  procedure :: mg_filtering_lin1,mg_filtering_lin2,mg_filtering_lin3
  procedure :: mg_filtering_rad2_ens
  procedure :: mg_filtering_lin2_ens
  procedure :: mg_filtering_fast_ens
  procedure :: mg_filtering_fast
  procedure :: mg_filtering_rad_highest
  procedure :: sup_vrbeta1T,sup_vrbeta1,sup_vrbeta3T,sup_vrbeta3
  procedure :: sup_vrbeta1_new,sup_vrbeta1T_new
...
!
!cltallocate(WORKA(km,1:nm,1:mm))                               ; WORKA=0.
      ...
      select case(this%my_hgen)
        ...
        if(.not.this%mgbf_line) then
           if(this%nxm*this%nym>1) then
              if(this%l_loc) then
                 if(this%l_loc_vertical) then
                    call this%cholaspect(1,this%lm,this%pasp1)
                    call this%getlinesum(this%hz,1,this%lm,this%pasp1,this%ss1)
                    do L=1,this%lm
                       this%VALL(L,2,1)=1.
                       call this%sup_vrbeta1T_new(1,0,0,this%hz,1,1,this%lm,this%pasp1,this%ss1,this%VALL(1:this%lm,2,1))
                       call this%sup_vrbeta1_new(1,0,0,this%hz,1,1,this%lm,this%pasp1,this%ss1,this%VALL(1:this%lm,2,1))
