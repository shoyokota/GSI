...
!    directory names (hardwired for now)
  ...
  character(len=max_varname_length), dimension(18), parameter :: &
    varfv3name = [character(len=max_varname_length) :: &
      'u','v','W','T','delp','sphum','o3mr','liq_wat','ice_wat','rainwat','snowwat','graupel','rain_nc','ref_f3d','ps','DZ','rainwat','graupel'], &
    vgsiname = [character(len=max_varname_length) :: &
      'u','v','w','tsen','delp','q','oz','ql','qi','qr','qs','qg','qnr','dbz','ps','delzinc','mask','maskh']
...
!$$$  end documentation block
    ...
    integer(i_kind):: ndynvario2d,ntracerio2d,nphyvario2d,ilev,jdynvar,jtracer,jphyvar,jmskvar
